            ...
            null === this.getAttribute("disabled") &&
              (function(t) {
                var e = t.parentNode,
                  ...
                  n = e.ownerDocument;
                if (!i || !u.hasClass(i, m))
                  return c.raiseError("Dropdown menu element not found");
                function o() {
                  u.removeClass(i, d),
                    u.off(n, "click", o),
                    u.off(n, "keydown", r);
                ...
                u.hasClass(i, d)
                  ...
                  : ((s = e.getBoundingClientRect()),
                    ...
                    (l = a.top - s.top + a.height),
                    u.css(i, "top", l + "px"),
                    u.addClass(i, d),
                    setTimeout(function() {
                      u.on(n, "click", o), u.on(n, "keydown", r);
                    }, 0));
                var s, a, l;
              })(this);
          }
            ...
            void 0 === (n = n || {}).keyboard && (n.keyboard = !0),
              ...
              (e = (function(t, e) {
                var i,
                  n = document,
                  o = n.body,
                  r = n.getElementById(u);
                if (
                  (n.activeElement && (s = n.activeElement),
                  a.enableScrollLock(),
                  r)
                ) {
                  ...
                  (r = n.createElement("div")).setAttribute("id", u),
                    r.setAttribute("tabindex", "-1"),
                    e && r.appendChild(e),
                    o.appendChild(r);
                return (
                  c.test(navigator.userAgent) && l.css(r, "cursor", "pointer"),
                  t.keyboard ? l.on(document, "keyup", f) : m(),
                  t.static ? p(r) : ((i = r), l.on(i, "click", h)),
                  (r.muiOptions = t),
                  r.focus(),
                  r
                );
        ...
        (p.prototype._createMenuEl = function(t, e) {
          ...
          (p.prototype.selectCurrent = function() {
            this.currentPos !== this.origPos &&
              ((this.selectEl.selectedIndex = this.itemArray[
                this.currentPos
              ]._muiIndex),
